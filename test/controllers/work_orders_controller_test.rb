...
class WorkOrdersControllerTest < ActionController::TestCase
  ...
  test "should create work_order" do
    assert_difference('WorkOrder.count') do
      post :create, work_order: { customerId: @work_order.customerId, endTime: @work_order.endTime, languageFrom: @work_order.languageFrom, languageTo: @work_order.languageTo, startTime: @work_order.startTime }
    end
  ...
  test "should update work_order" do
    patch :update, id: @work_order, work_order: { customerId: @work_order.customerId, endTime: @work_order.endTime, languageFrom: @work_order.languageFrom, languageTo: @work_order.languageTo, startTime: @work_order.startTime }
    assert_redirected_to work_order_path(assigns(:work_order))
  end
